...
html_prefix = '<!DOCTYPE html>\n<html dir="rtl" lang="he">\n<head>\n<title>תקציר סביר</title>\n' + \
  ...
  '<div class="container">\n <div class="row text-center"> \n <div class="col-md-4"> \n <h1 style="text-align:center">תקציר פסקי דין</h1> \n' + \
    ...
    '<div class="col-md-4"> \n <h2><a href="maft_index.html">מפתח עניינים</a></h2> \n </div>\n <div class="col-md-8"> \n <div class="gcse-search"></div>\n </div> \n' + \
    '</div>\n </div>\n'
...
maft_files = sorted(os.listdir(maft_processed_dir))
for maft_file in maft_files:
    sitemap = sitemap + f'http://nsavir.co.il/{os.path.join(maft_processed_dir, maft_file)}\n'
